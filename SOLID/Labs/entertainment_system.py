...
class Television(RcaConnection, HDMIConnection, PowerOutlet):
...
class DVDPlayer(HDMIConnection, PowerOutlet):
...
class GameConsole(HDMIConnection, EthernetConnection, PowerOutlet):
    def connect_to_tv(self, television):
        self.connect_to_device_via_hdmi_cable(television)
...
class Router(EthernetConnection, PowerOutlet):
    def connect_to_tv(self, television):
